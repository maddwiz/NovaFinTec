...
- `AION_EXT_RUNTIME_HEARTBEAT_WARN_SCALE`, `AION_EXT_RUNTIME_HEARTBEAT_ALERT_SCALE`
- `AION_EXT_RUNTIME_COUNCIL_WARN_SCALE`, `AION_EXT_RUNTIME_COUNCIL_ALERT_SCALE`
...
- `AION_EXT_RUNTIME_RISK_STALE_SCALE`, `AION_EXT_RUNTIME_RISK_HEARTBEAT_WARN_SCALE`, `AION_EXT_RUNTIME_RISK_HEARTBEAT_ALERT_SCALE`
- `AION_EXT_RUNTIME_RISK_COUNCIL_WARN_SCALE`, `AION_EXT_RUNTIME_RISK_COUNCIL_ALERT_SCALE`
...
- External overlay entry safety gate:
- `AION_EXT_SIGNAL_BLOCK_CRITICAL`, `AION_EXT_SIGNAL_BLOCK_CRITICAL_FLAGS`
- `AION_EXT_SIGNAL_BLOCK_ON_QUALITY_FAIL`
- `AION_EXT_SIGNAL_BLOCK_STALE_HOURS` (hard-block new entries only when stale age breaches this threshold)
- NovaSpine memory feedback runtime controls:
- `AION_EXT_SIGNAL_MEMORY_FEEDBACK_ENABLED`
- `AION_EXT_SIGNAL_MEMORY_FEEDBACK_MIN_SCALE`, `AION_EXT_SIGNAL_MEMORY_FEEDBACK_MAX_SCALE`
- `AION_EXT_SIGNAL_MEMORY_FEEDBACK_ALERT_THRESHOLD`, `AION_EXT_SIGNAL_MEMORY_FEEDBACK_BLOCK_ON_ALERT`
- Execution quality governor (turnover/slippage runtime throttles):
- `AION_EXEC_GOVERNOR_ENABLED`, `AION_EXEC_GOVERNOR_LOOKBACK_MIN`, `AION_EXEC_GOVERNOR_MIN_EXECUTIONS`
- `AION_EXEC_GOVERNOR_SLIP_WARN_BPS`, `AION_EXEC_GOVERNOR_SLIP_ALERT_BPS`
- `AION_EXEC_GOVERNOR_RATE_WARN_PER_MIN`, `AION_EXEC_GOVERNOR_RATE_ALERT_PER_MIN`
- `AION_EXEC_GOVERNOR_BLOCK_ON_ALERT`
- `AION_EXEC_GOVERNOR_WARN_TRADES_SCALE`, `AION_EXEC_GOVERNOR_WARN_OPEN_SCALE`, `AION_EXEC_GOVERNOR_WARN_RISK_SCALE`
- `AION_EXEC_GOVERNOR_ALERT_TRADES_SCALE`, `AION_EXEC_GOVERNOR_ALERT_OPEN_SCALE`, `AION_EXEC_GOVERNOR_ALERT_RISK_SCALE`
- Promotion gate execution-quality thresholds:
- `AION_PROMOTION_MIN_SLIPPAGE_SAMPLES`
- `AION_PROMOTION_MAX_AVG_SLIPPAGE_BPS`, `AION_PROMOTION_MAX_P90_SLIPPAGE_BPS`
- `AION_PROMOTION_MAX_CLOSED_TRADES_PER_DAY`
