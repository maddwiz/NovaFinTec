...
def test_build_alert_payload_uses_system_health_shape_for_aion_feedback_when_overlay_missing():
    ...
    assert payload["observed"]["aion_feedback_source_selected"] == "system_health_shape"
    assert payload["observed"]["aion_feedback_source_preference"] == "auto"
...
def test_build_alert_payload_honors_overlay_source_preference():
    payload = rha.build_alert_payload(
        health={"health_score": 95, "issues": [], "shape": {}},
        guards={"global_governor": {"mean": 0.85}},
        nested={"assets": 4, "avg_oos_sharpe": 0.8},
...
def test_build_alert_payload_honors_shadow_source_preference():
    payload = rha.build_alert_payload(
        health={"health_score": 95, "issues": [], "shape": {}},
        guards={"global_governor": {"mean": 0.85}},
        nested={"assets": 4, "avg_oos_sharpe": 0.8},
...
def test_build_alert_payload_triggers_cross_hive_turnover_alerts():
    payload = rha.build_alert_payload(
        health={"health_score": 95, "issues": []},
        guards={"global_governor": {"mean": 0.85}},
        nested={"assets": 4, "avg_oos_sharpe": 0.8},
        ...
        thresholds={
            ...
            "max_concentration_top1_after": 0.30,
            "max_portfolio_l1_drift": 1.2,
            "max_cross_hive_mean_turnover": 0.40,
            "max_cross_hive_max_turnover": 0.90,
            "max_cross_hive_rolling_turnover": 1.20,
        },
    )
    assert any("cross_hive_mean_turnover>" in a for a in payload["alerts"])
    assert any("cross_hive_max_turnover>" in a for a in payload["alerts"])
    assert any("cross_hive_rolling_turnover>" in a for a in payload["alerts"])


def test_build_alert_payload_triggers_memory_turnover_alerts_from_health_shape():
    payload = rha.build_alert_payload(
        health={
            "health_score": 95,
            "issues": [],
            "shape": {
                "novaspine_turnover_pressure_max": 0.84,
                "novaspine_turnover_dampener_max": 0.13,
            },
        },
        guards={"global_governor": {"mean": 0.85}},
        nested={"assets": 4, "avg_oos_sharpe": 0.8},
        ...
        thresholds={
            ...
            "max_concentration_top1_after": 0.30,
            "max_portfolio_l1_drift": 1.2,
            "max_memory_turnover_pressure": 0.72,
            "max_memory_turnover_dampener": 0.10,
        },
    )
    assert any("memory_turnover_pressure>" in a for a in payload["alerts"])
    assert any("memory_turnover_dampener>" in a for a in payload["alerts"])


def test_build_alert_payload_triggers_novaspine_turnover_quality_alert():
    payload = rha.build_alert_payload(
        health={"health_score": 95, "issues": []},
        guards={"global_governor": {"mean": 0.85}},
        nested={"assets": 4, "avg_oos_sharpe": 0.8},
        quality={
            "quality_governor_mean": 0.88,
            "quality_score": 0.72,
            "components": {"novaspine_turnover": {"score": 0.31}},
        },
        immune={"ok": True, "pass": True},
        pipeline={"failed_count": 0},
        shock={"shock_rate": 0.05},
        ...
        thresholds={
            ...
            "max_concentration_top1_after": 0.30,
            "max_portfolio_l1_drift": 1.2,
            "min_novaspine_turnover_quality": 0.45,
        },
    )
