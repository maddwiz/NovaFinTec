...
- `runs_plus/meta_mix_alpha.csv`
- `runs_plus/meta_mix_gross.csv`
...
- `runs_plus/dna_stress_components.csv`
- `runs_plus/reflex_health_governor.csv`
- `runs_plus/reflex_health_info.json`
- `runs_plus/reflex_health_components.csv`
...
export Q_ENABLE_AUTO_TURNOVER_GOV=1
export Q_AUTO_TURNOVER_MAX_STEP=0.30
export Q_AUTO_TURNOVER_BUDGET_WINDOW=5
export Q_AUTO_TURNOVER_BUDGET_LIMIT=1.00
...
```
Health alert controls:
```bash
export Q_MIN_HEALTH_SCORE=70
export Q_MIN_GLOBAL_GOV_MEAN=0.45
export Q_MIN_QUALITY_GOV_MEAN=0.58
export Q_MIN_QUALITY_SCORE=0.45
export Q_QUALITY_GOV_MAX_STEP=0.06
export Q_MAX_QUALITY_GOV_ABS_STEP=0.12
export Q_MAX_HEARTBEAT_STRESS=0.85
export Q_MIN_EXEC_GROSS_RETENTION=0.10
export Q_MIN_EXEC_TURNOVER_RETENTION=0.05
export Q_MAX_EXEC_TURNOVER_RETENTION=1.10
export Q_MAX_STALE_REQUIRED_COUNT=0
export Q_SYSTEM_HEALTH_MAX_REQUIRED_HOURS=24
export Q_SYSTEM_HEALTH_MAX_OPTIONAL_HOURS=72
